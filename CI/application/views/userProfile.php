...
<div class="container">
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>"><?php echo $homepage?></a></li>
...
<!--     <div class="col-md-2">
  ...
  <div class="col-md-12">
      <h3 class="text-center"><?php echo $myDetails?></h3>
      ...
      <form action="<?php echo base_url().'Profile/update'; ?>" method="post" style="padding: 10px;">
  ...
  <div class="tab-pane fade" id="hospital" role="tabpanel" aria-labelledby="hospital-tab">
    ...
    <div class="details_email">     
      <form action="<?php echo base_url().'Profile/email'; ?>" method="post">
        ...
        <div class="change_button" style ="padding: 10px;">
          <button type="submit" class="btn btn-outline-primary btn-block">
            <?php echo $change?>
          </button>
        </div>
