    ...
    <div class="col-md-3">
      <div class="toc position-sticky" style="top: 2rem; overflow: auto; text-align: center;">
        <ul class="list-group list-group-flush my-4" style="width: 220; ">
          <li class="list-group-item" style="background-color: #42A5F5; color:#FFFFFF;"><a href = "#serviceType" style="color:#FFFFFF;"><?php echo $serviceType?></a></li>
          ...
          <li class="list-group-item" style="background-color: #42A5F5; color:#FFFFFF;"><a href = "#specialist" style="color:#FFFFFF;"><?php echo $specialist?></a></li>
          ...
          <li class="list-group-item" style="background-color: #42A5F5; color:#FFFFFF;"><a href = "#allied" style="color:#FFFFFF;"><?php echo $allied?></a></li>
          <li class="list-group-item" style="background-color: #007bff; color:#FFFFFF;"><a href = "#ed" style="color:#FFFFFF;"><?php echo $ed?></a></li>
          <li class="list-group-item" style="background-color: #42A5F5; color:#FFFFFF;"><a href = "#hospitals" style="color:#FFFFFF;"><?php echo $hospitals?></a></li>
          ...
          <li class="list-group-item" style="background-color: #42A5F5; color:#FFFFFF;"><a href = "#medicines" style="color:#FFFFFF;"><?php echo $medicines?></a></li>
        </ul>
      </div>
    </div> 
